...
//   $.getJSON(`${host}/api/v1/mealsReference?date=${date}`, function(databaseMealsReference){
//     Object.keys(databaseMealsReference).forEach(function(mealName) {
//       var mealFoods = databaseMealsReference[mealName]
...
//       console.log(mealName, mealTotal)
