...
var meals = {'breakfast': 400, 'lunch': 600, 'dinner': 800, 'snacks': 200}
...
function generateMealDiaries(formattedDate) {
  var mealNames = Object.keys(meals)
  mealNames.forEach(function(mealName) {
    getMealFoods(mealName, formattedDate)
  })
}
...
function mealCalTotal(mealName, mealFoods){
  ...
  var remaining = meals[mealName] - sum
  var remainingDiv = $(`.${mealName}-remaining`)
